...
<section class="w-process bg-sfgrey-2">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 mb-3">
                 <iframe style="width: 100%; margin:2px auto;" height="350" src="https://www.youtube.com/embed/s_PDNKAdl5Q" title="Поздравление от врачей &quot;Zarmed Pratiksha&quot; во Всемирный День Медсестры." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </div>
    </div>
</section>