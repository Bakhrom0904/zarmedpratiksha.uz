    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <img class="w-100" src="https://zarmedpratiksha.uz/uploads/Zarmed%20Kompaniyalari/Zarmed-Qarshi.jpg?_t=1717417966">
                    <p class="py-3">
                       <?php if(Yii::$app->language == 'ru'): ?>
                        Медицинский центр 'Zarmed' в городе Карши - это современное медицинское учреждение, предоставляющее широкий спектр медицинских услуг высокого качества. Наш центр оснащен передовым оборудованием и обладает опытным медицинским персоналом, готовым обеспечить пациентов качественным и эффективным медицинским обслуживанием.<br><br>
                        В медицинском центре 'Zarmed' предоставляется полный спектр медицинских направлений, а наши специалисты имеют богатый опыт и постоянно совершенствуют свои навыки для обеспечения наилучшего уровня медицинской помощи.<br><br>
                        Кроме того, в медицинском центре 'Zarmed' доступны современные методы диагностики, такие как магнитно-резонансная томография (МРТ), мультиспиральная компьютерная томография (МСКТ) и рентгенография. Эти методы позволяют проводить точные и своевременные диагностику различных заболеваний и состояний, что является важным звеном в обеспечении комплексного медицинского ухода.<br><br>
                      ...
                      <?php else: ?>
                        ...
                        Zarmed tibbiyot markazida magnit-rezonans tomografiya (MRT), multispiral kompyuter tomografiyasi (MSKT) va rentgenografiya kabi zamonaviy diagnostika usullari mavjud . Bu usullar turli xastalik va holatlarni to‘g‘ri va o‘z vaqtida aniqlash imkonini beradi, bu esa kompleks tibbiy yordam ko‘rsatishning muhim bo‘g‘ini hisoblanadi.<br><br>
                        “Zarmed” tibbiyot markazi har bir bemorga professional va g'amxo'r davolanishni, shuningdek, optimal natijalarga erishish uchun eng zamonaviy davolash va diagnostika usullarini qo'llashga intiladi. Bizning maqsadimiz - bizga kelgan har bir bemorning salomatligi va farovonligini ta'minlash.<br><br>
                        Manzil : Qarshi, Islom Karimov ko’chasi, 474<br>
                        Tel : +998 91 219 00 35  +998 95 681 00 35
                      <?php endif; ?>    
                    </p>
                </div>
            </div>
