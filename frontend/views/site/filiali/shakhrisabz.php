    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <img class="w-100" src="https://zarmedpratiksha.uz/uploads/Zarmed%20Kompaniyalari/Shahrisabz.jpg?_t=1701637789">
                    <p class="py-3">
                       <?php if(Yii::$app->language == 'ru'): ?>
                        Диагностический центр "Zarmed" в городе Шахрисабз — это передовое медицинское учреждение, где современная аппаратура и высококвалифицированные специалисты объединяются, чтобы помочь больным в любую минуту. Наш центр оснащен новейшими медицинскими приборами, обеспечивающими точные диагностические исследования для выявления различных заболеваний.<br><br>
                        Магнитно-резонансный томограф (МРТ) и мультиспиральная компьютерная томография (МСКТ) позволяют проводить высокоточные сканирования органов и тканей, обеспечивая быструю и точную диагностику. Наши специалисты, имеющие обширный опыт и профессиональные навыки, готовы оказать квалифицированную помощь пациентам в любой ситуации.<br><br>
                        Наш лабораторный центр оснащен современным оборудованием для проведения разнообразных анализов, что позволяет быстро и точно определить состояние здоровья пациента. Мы ценим каждого пациента и гарантируем индивидуальный подход к каждому случаю, обеспечивая высокий стандарт медицинского обслуживания.<br><br>
                      ...
                      <?php else: ?>
                        ...
                        Laboratoriya markazimiz turli testlarni o‘tkazish uchun zamonaviy asbob-uskunalar bilan jihozlangan bo‘lib, bemorning salomatlik holatini tez va to’liq aniqlash imkonini beradi. Biz har bir bemorni qadrlaymiz va har bir holatga individual yondashishni kafolatlaymiz, tibbiy yordamning yuqori standartini ta'minlaymiz.<br><br>
                        Shahrisabz shahridagi “ Zarmed ” diagnostika markazi har bir bemorga o‘z vaqtida sifatli tibbiy yordam ko‘rsatishini ta’minlashga intiladi va bizning mutaxassislarimiz sizga har daqiqada yordam ko‘rsatishga, davolanishning har bir bosqichida yordam ko‘rsatishga tayyor.<br><br>
                        Manzil : Shahrisabz , Ipak Yo’li ko’chasi, 108<br>
                        Tel : +998 95 505 77 00
                      <?php endif; ?>    
                    </p>
                </div>
            </div>
