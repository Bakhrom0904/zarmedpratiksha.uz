...
<section class="service" style="margin-top:130px;background-color:#F6F8FA">
        <div class="container">
            <div class="sc-title-two text-center">
                <h2 style="color:#283779;text-transform:uppercase"><?= Lx::t('frontend', 'CHECK-UP FAMILY PROGRAM') ?><span style="color:#F19035"> -30 %</span></h2>
            </div>
            <div class="row">
                    <!-- WOMEN -->
                ...
                <h3 style="color:#283779;text-transform:uppercase"><?= Lx::t('frontend', 'PROGRAM FOR WOMEN') ?></h3>
                                ...
                                <h4 style="color:#283779"><?= Lx::t('frontend', 'ECG') ?></h4>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                <h3 style="color:#F19035;text-transform:uppercase">ПРОГРАММА ДЛЯ ДЕТЕЙ</h3>
                                <h4 style="color:#283779">Консультации</h4>
                                <h4 style="color:#F19035">Педиатр</h4>
                                <h4 style="color:#F19035">Детский невропатолог </h4>

                                <h3 style="color:#283779"><span style="text-decoration:line-through;">584</span>  410 <?= Lx::t('frontend', 'sum') ?></h3>             
                </div>
                <div class="col-lg-3 col-md-6 col-6">
                <h3 style="color:#F19035;text-transform:uppercase">ПРОГРАММА СТАНДАРТНОЙ ДИАГНОСТИКИ</h3>
