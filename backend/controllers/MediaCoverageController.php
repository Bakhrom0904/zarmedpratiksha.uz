...
use common\models\MediaCoverageSearch;
...
class MediaCoverageController extends Controller
{
    ...
    /**
     * Displays a single MediaCoverage model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Deletes an existing MediaCoverage model.
     ...
     * @param int $id ID
     * @return MediaCoverage the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = MediaCoverage::findOne(['id' => $id])) !== null) {
            return $model;
        }
